        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-300 text-sm leading-relaxed mb-4">
              A group of medical students eager to help premed students achieve their dreams.
            </p>
            <div className="flex space-x-4">
              <a href="https://instagram.com/medpathucsd" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-ucsd-gold transition-colors">
