          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-64 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                ...
                <Link href="/resources/pre-med-guide" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                  Pre-Med Guide
                </Link>
                <Link href="/resources/recommendations" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                  Recommendations
                </Link>
                <Link href="/resources/transfer-students" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                  Transfer Students
                </Link>
              </div>
            </div>
